...
import type { RequestInit, RequestInfo, BodyInit } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/builtin-types';
import type { HTTPMethod, PromiseOrValue, MergedRequestInit, FinalizedRequestInit } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/types';
import { uuid4 } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/utils/uuid';
import { validatePositiveInteger, isAbsoluteURL, safeJSON } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/utils/values';
import { sleep } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/utils/sleep';
export type { Logger, LogLevel } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/utils/log';
import { castToError, isAbortError } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/errors';
import type { APIResponseProps } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/parse';
import { getPlatformHeaders } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/detect-platform';
import * as Shims from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/shims';
import * as Opts from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/request-options';
import * as qs from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/qs';
import { VERSION } from '.pnpm/openai@5.12.2/node_modules/openai/src/version';
import * as Errors from '.pnpm/openai@5.12.2/node_modules/openai/src/core/error';
import * as Pagination from '.pnpm/openai@5.12.2/node_modules/openai/src/core/pagination';
import { AbstractPage, type CursorPageParams, CursorPageResponse, PageResponse } from '.pnpm/openai@5.12.2/node_modules/openai/src/core/pagination';
import * as Uploads from '.pnpm/openai@5.12.2/node_modules/openai/src/core/uploads';
import * as API from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/index';
import { APIPromise } from '.pnpm/openai@5.12.2/node_modules/openai/src/core/api-promise';
import {
  Batch,
  BatchCreateParams,
  BatchError,
  ...
  Batches,
  BatchesPage,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/batches';
import {
  Completion,
  CompletionChoice,
  ...
  CompletionUsage,
  Completions,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/completions';
import {
  ...
  EmbeddingModel,
  Embeddings,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/embeddings';
import {
  FileContent,
  FileCreateParams,
  FileDeleted,
  ...
  FilePurpose,
  Files,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/files';
import {
  Image,
  ...
  Images,
  ImagesResponse,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/images';
import { Model, ModelDeleted, Models, ModelsPage } from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/models';
import {
  Moderation,
  ...
  ModerationTextInput,
  Moderations,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/moderations';
import { Webhooks } from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/webhooks';
import { Audio, AudioModel, AudioResponseFormat } from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/audio/audio';
import { Beta } from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/beta/beta';
import { Chat } from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/chat/chat';
import {
  ...
  Containers,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/containers/containers';
import {
  EvalCreateParams,
  EvalCreateResponse,
  ...
  EvalUpdateResponse,
  Evals,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/evals/evals';
import { FineTuning } from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/fine-tuning/fine-tuning';
import { Graders } from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/graders/graders';
import { Responses } from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/responses/responses';
import {
  Upload,
  UploadCompleteParams,
  UploadCreateParams,
  Uploads as UploadsAPIUploads,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/uploads/uploads';
import {
  ...
  VectorStores,
  VectorStoresPage,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/vector-stores/vector-stores';
import {
  ChatCompletion,
  ...
  ChatCompletionsPage,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/resources/chat/completions/completions';
import { type Fetch } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/builtin-types';
import { isRunningInBrowser } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/detect-platform';
import { HeadersLike, NullableHeaders, buildHeaders } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/headers';
import { FinalRequestOptions, RequestOptions } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/request-options';
import { readEnv } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/utils/env';
import {
  type LogLevel,
  type Logger,
  ...
  loggerFor,
  parseLogLevel,
} from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/utils/log';
import { isEmptyObj } from '.pnpm/openai@5.12.2/node_modules/openai/src/internal/utils/values';
